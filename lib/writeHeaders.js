...
var writeHeaders = {
    ...
    writeAllHeaders: function(outputDir) {
        ...
        var dimensionsHeaders = ['DimensionID', 'Grouping', 'FieldDefinition', 'FieldLabel', 'DimensionTitle', 'Title', 'Description', 'Tags'];
        ...
        var measuresHeaders = ['MeasureID', 'Name', 'Definition', 'Grouping', 'Expressions', 'ActiveExpressions', 'Title', 'Description', 'Tags'];
